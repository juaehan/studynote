...
// 일반 변수끼리 복사한 경우 원본이 변경되면 복사본에는 영향이 없음
a++;
console.log("a= "+a+", b="+b);  // a=101, b=100


/** 참조복사 (=얕은복사) */
// 배열, JSON, 객체끼리의 복사는 참조처리 된다
// 원본을 수정하면 복사본도 수정됨(반대의 경우도 마찬가지)
const user = {
    name: "Lee"
};
...
console.log(copy2);  // { city: '서울', gu: '서초' } --> 만약 copy2에 내용이 있으면 copy2내용 먼저 출력 후 이어서 city~가 출력됨