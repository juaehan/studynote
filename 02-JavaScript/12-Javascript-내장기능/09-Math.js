...
console.log("최대값: " + max);      // 1000

/**(2) 주어진 값 중에서 최소값(파라미터 수 제한 없음) */
let min = Math.min(100, 123);
console.log("최소값: " + min);      // 100

/**(3) 소수점 반올림 */
let num1 = 3.7146;
console.log("소수점 반올림: " + Math.round(num1));      // 4

/**(4) 소수점 올림과 내림 */
console.log("소수점 올림: " + Math.ceil(num1));         // 4
console.log("소수점 내림: " + Math.floor(num1));        // 3

/**(5) 절대값을 반환 */
let num2 = -123;
console.log("절대값: " + Math.abs(num2));       // 123
