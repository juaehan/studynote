...
const DepartmentPath = () => {
    ...
    console.debug(params);      // {'id': 201, 'msg': 'hello'}
    ...
    console.debug('요청된 학과번호 값=%s (%s)', params.id, typeof params.id);       // 요청된 학과번호 값=201 (string)
    console.debug('요청된 메시지 내용=%s (%s)', params.msg, typeof params.msg);     // 요청된 메시지 내용=hello (string)
