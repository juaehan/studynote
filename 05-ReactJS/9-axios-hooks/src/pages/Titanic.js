...
const EmbarkedBox = styled.span`
    &::before{
        ...
        content: '${({embarked}) => embarked === 'C' ? '셰르부르' : (embarked === 'Q' ? '퀸즈타운' : '샤우샘프턴')}';
        font-weight: 600;
    }
`;
...
const Tatanic = () => {
    ...
    const onSelectChange = React.useCallback(e => {
        ...
        // 드롭다운의 name 속성과 일치하는 key에 대한 value를 수정 --> sex: 남자
    ...
    React.useEffect(() => {
        // 이 컴포넌트가 화면에 마운트 된 이후에만 동작하도록 한다.
...
export default React.memo(Tatanic);