        ...
        storage: multer.diskStorage({
            ...
            destination: (req, file, callback) => {
                ...
                */
                ...
                // 업로드 정보에 백엔드의 업로드 파일저장 폴더 위치를 추가한다.
                // 윈도우 환경을 고려하여 역슬래시를 슬래시로 변겨하는 처리 추가
            ...
            filename: (req, file, callback) => {
                ...
                */
                ...
                // 파일이 저장될 이름 (현재_시간의_timestamp + 확장자)
...
const createThumbnail = file => {
    ...
    size.map(async (v, i) => {
        ...
        // 프로트엔드에게 전송될 정보에 'thumbnail'이라는 프로퍼티 없다면 빈 json 형태로 생성
